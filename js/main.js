...
function setXAxis() {
  episodes.forEach(function (episode, i) {
    ...
    plot
      ...
      .attr(
        "d",
        "M" + scaleX(i) + "," + scaleY(0) + "L" + scaleX(i) + "," + scaleY(99)
      )
      .style("opacity", "0.1")
  ...
  topDivs
    ...
    .html(function (d) {
      var letter =
        ...
        "</div>";
      var letter2 =
        '<div class="letter2" style="background: ' +
        getBackground2(d) +
        "; color: " +
        getTextColor2(d) +
        '">' +
      ...
      return (
        td(rank, "smWidth") +
        td(d.name, "nameWidth") +
        td(d.company, "companyWidth") +
        td(letter, "smWidth") +
        td(letter2, "smWidth") +
        td(displayRankChange(d), "rankWidth")
      );
    })
...
function getImageSource(d) {
  return "pics/" + d.name.replace(/ /g, "").toLowerCase() + ".jpg";
}
...
function displayRankChange(d) {
  if (d.rankChange == "-") {
    ...
    return (
      "<img src='img/up-arrow.png' class='arrow'><span class='change up'>" +
      d.rankChange +
      "<span>"
    );
  } else if (d.rankChange < 0) {
    return (
      "<img src='img/down-arrow.png' class='arrow'><span class='change down'>" +
